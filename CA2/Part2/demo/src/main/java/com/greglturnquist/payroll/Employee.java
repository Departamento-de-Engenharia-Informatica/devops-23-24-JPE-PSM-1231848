...
public class Employee {
	...
	public Employee(String firstName, String lastName, String description, int jobYears) throws InstantiationException{
		if(!areEmployeeParametersValid(firstName, lastName,description,jobYears)){
	...
	private boolean areEmployeeParametersValid(String firstName, String lastName, String description, int jobYears) {
